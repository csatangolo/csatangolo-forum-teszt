-- CSATANGOLÓ BELÉPTETÉS 2.0 – TESZT jogosultságok
-- Supabase TEST projektben futtasd, ha a beléptetés mentése vagy helyszíni regisztráció nem működik.
-- Nem töröl adatot.
...
select 'Beléptetés 2.0 teszt jogosultságok beállítva.' as status;
