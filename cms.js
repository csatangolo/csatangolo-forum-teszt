...
const DEFAULT_SPEAKERS = [
  ...
  { name:"Szabó Árpád", subtitle:"Akhal-teke tenyésztő • Csikónevelés", image_url:"szabo-arpad-card.jpg", motto:"Először ki kell vívni a ló tiszteletét. Aztán el kell nyerni a bizalmát.", bio:"48 éve foglalkozom lovakkal, és úgy érzem, ma is ugyanazzal a lelkesedéssel tanulok tőlük, mint amikor először ültem nyeregbe. Számomra a lótenyésztés nem a csikó megszületéséig tart, hanem éppen ott kezdődik. Hiszem, hogy a tenyésztő felelőssége már az első pillanattól kialakítani azt a bizalmi kapcsolatot, amelyre később minden további képzés épülhet.", topic:"Csikónevelés | Tenyésztői felelősség | Akhal-teke fajta", facebook_url:"https://www.facebook.com/share/p/18LLaey9Xi/", website_url:"https://nava.hu/id/4473109/", sort_order:5, is_featured:false, is_published:true },
  { name:"Kaska Zoltán", subtitle:"Díjugratás • Versenytapasztalat", image_url:"kaska-zoltan.jpg", motto:"A jó ugrás a felkészítésben kezdődik.", bio:"Díjugrató szemlélettel, versenytapasztalattal és gyakorlati lófelkészítési gondolatokkal érkezik a fórumra.", topic:"Díjugratás | Versenyló | Felkészítés", sort_order:6, is_featured:false, is_published:true },
  { name:"Benner Jani", subtitle:"Terepmunka • Használati ló képzés", image_url:"benner-jani.jpg", motto:"A képzett ló terepen is magabiztos, figyelmes és együttműködő.", bio:"A használati szemléletű lókiképzés, a terepen is működő lovak és a gyakorlati tapasztalat oldaláról kapcsolódik a szakmai naphoz.", topic:"Terepmunka | Használati ló | Lókiképzés", sort_order:7, is_featured:false, is_published:true },
  { name:"Tisza Zoltán", subtitle:"Szabadidomítás • Lóval való kommunikáció", image_url:"tisza-zoltan.jpg", motto:"A látványos munka mögött mindig pontos kommunikáció és bizalom áll.", bio:"A lóval való földi munka, a figyelem, a bizalom és a finom kommunikáció területéről hoz gyakorlati tapasztalatokat.", topic:"Szabadidomítás | Földi munka | Kommunikáció", sort_order:8, is_featured:false, is_published:true },
  { name:"Tászler Melinda", subtitle:"Szakágfüggetlen földi idomítómunka", image_url:"taszler-melinda.jpg", motto:"A bizalom a földön kezdődik.", bio:"A lovak mindig arra tanítottak, hogy az igazi kapcsolat nem a felszereléseken múlik, hanem a bizalmon, a türelmen és a kölcsönös megértésen. Több mint húsz éve foglalkozom lovakkal, és az évek során a földi idomítómunka vált a legfontosabb szakterületemmé.\n\nHiszem, hogy minden sikeres lovas kapcsolat alapja a földről kezdődik. A szakágfüggetlen földi idomítómunka nem csupán egy módszer, hanem egy szemlélet, amely segít megérteni a ló gondolkodását, tiszta kommunikációt kialakítani, és olyan bizalmat építeni, amely később a nyeregben is érezhető.", topic:"Földi idomítómunka | Bizalom | Kommunikáció", sort_order:9, is_featured:false, is_published:true },
  { name:"Szabó Zoltán", subtitle:"Terepakadályok • Gyakorlati képzés", image_url:"szabo-zoltan.jpg", motto:"A bátorság tanítható, ha a ló lépésről lépésre érti a feladatot.", bio:"Gyakorlati terepakadályos tapasztalattal és használati szemléletű lófelkészítéssel kapcsolódik a fórum programjához.", topic:"Terepakadály | Bátorság | Gyakorlati képzés", sort_order:10, is_featured:false, is_published:true }
];
